...
sub make_Hebag_mother
{
	...
	$detector{"pos"}         = "0*mm 0*mm 884.61*mm";
	$detector{"type"}        = "Tube";
	$detector{"dimensions"}  = "0.0*mm 26.0*mm 704.39*mm 0*deg 360*deg";
...
sub make_Hebag_tube
{
	...
	$detector{"type"}        = "Tube";
	$detector{"dimensions"}  = "$rmin*mm $rmax*mm 704.39*mm $phistart*deg $pspan*deg";
